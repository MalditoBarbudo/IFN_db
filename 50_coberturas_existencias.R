...
# 
# save(counties_cob_and_existencies, file = 'data_raw/counties_cob_and_existencies.RData')

load('data_raw/counties_cob_and_existencies.RData') %>%
  tibble::as_tibble() -> counties_cob_and_existencies
